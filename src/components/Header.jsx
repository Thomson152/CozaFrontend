          ...
          {userInfo ? (
            <div className="inline-flex  rounded-md">
              ...
              <div className="relative">
                ...
                <div className={`${dropdownOpen ? `top-full opacity-100 visible` : `top-[110%] invisible opacity-0`} absolute right-0 z-10 w-40 mt-4  transition-all bg-white border border-gray-100 rounded-md shadow-lg`}>
                  <div className="p-2">
                    <Link
